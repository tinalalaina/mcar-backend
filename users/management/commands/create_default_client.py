...
class Command(BaseCommand):
    help = "Crée un super client par défaut s'il n'existe pas déjà."

    def handle(self, *args, **options):
        email =os.environ.get( "DEFAULT_CLIENT_EMAIL", None)
        password =os.environ.get( "DEFAULT_CLIENT_PASSWORD", None)
        first_name =os.environ.get( "DEFAULT_CLIENT_FIRST_NAME", "Super")
        last_name =os.environ.get( "DEFAULT_CLIENT_LAST_NAME", "Admin")
        ...
        try:
            ...
            user = User.objects.create_user(
                ...
                last_name=last_name,
                role="CLIENT",          # très important pour ton modèle
