...
@receiver(pre_save, sender=MarketingHeros)
def marketinghero_pre_save(sender, instance, **kwargs):
    _cleanup_old_file(instance, "image", MarketingHeros)


@receiver(pre_delete, sender=MarketingHeros)
def marketinghero_pre_delete(sender, instance, **kwargs):
    if instance.image:
